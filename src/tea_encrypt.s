...
section .text
	global _tea_encrypt				; int tea_encrypt(uint32_t msg[2], const uint32_t key[4]);
...
_tea_encrypt:
	...
	mov		[rbp - 36], dword 0		; sum 


.tea_loop:
	
	mov		r11d, dword [rbp - 28]	;
	add		[rbp - 36], r11d 		; ADD DELTA TO SUM
